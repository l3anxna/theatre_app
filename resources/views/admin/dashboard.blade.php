<x-app-layout>
    ...
    <div class="mx-auto max-w-6xl">
        <section class="rounded-3xl border border-stage-accent/25 bg-gradient-to-r from-stage-primary via-[#4c296f] to-stage-secondary p-6 sm:p-8">
